...
import { userSet } from '../../root/redux/actions';
import t from '../../lang';
...
class EditProfile extends Component {
  ...
  _getData = () => {
    request({
      ...
      let role   = '';
      let gender = '';
      this.state.data_gender.map((item, index) => {
      ...
      this.setState({
          ...
          nama_darurat_satu   : data?.nama_darurat_satu,
          notelp_darurat_satu : data?.notelp_darurat_satu,
          nama_darurat_dua    : data?.nama_darurat_dua,
          notelp_darurat_dua  : data?.notelp_darurat_dua,
        ...
        <Layout style={[layout.container, styles.containerInner]}>
          {
            ...
            (
              ...
              }
              {
                ...
                <>
                  ...
                  <Input
                    ...
                    value={this.state.notelp_darurat_satu}
                  ...
                  <Input
                    ...
                    value={this.state.notelp_darurat_dua}
              ...
              <Button style={{marginTop: 15, marginBottom: 10}} status="info" onPress={(this.state.page != 3) ? this._next : this._prosesRegister}>{(this.state.page != 3) ? t('bBerikutnya') : t('bUpdate')}</Button>
              {
                (this.state.page != 1) &&
  ...
  _register = () => {
    this.setState({isProcess : true}, () => {
      request({
        ...
        if (res.success) {
          Toast.show(t('aSimpanSuccess'), Toast.LONG);
