...
class BuktiBayar extends Component {
    ...
    constructor(props) {
      ...
      this.state = {
        ...
        menuSort      : [
          {
            label : 'Semua',
            value : {'sewa.status_sewa !=' : '0'},
            badge : 0,
          },
          {
            label : 'Menunggu',
            value : 'sewa.status_sewa = "1" OR sewa.status_sewa = "2" OR sewa.status_sewa = "4"',
            badge : 0,
          },
          {
            label : 'Check In',
          ...
          {
            label : 'Check Out',
            value : {'sewa.status_sewa' : '5'},
            badge : 0,
          },
          {
            label : 'Batal',
            value : 'sewa.status_sewa = "6" OR sewa.status_sewa = "7"',
            badge : 0,
          },
        ]
      }
    ...
    componentDidMount = () => {
      let text = ['Semua', 'Menunggu Pembayaran', 'Menunggu Konfirmasi', 'Check In', 'Check Out'];
      let resDefault = 0;
      this.setState({
        indexSort   : resDefault,
        filterText  : text[resDefault],
        filter      : (resDefault != '0') ? {'status_sewa' : resDefault} : {'status_sewa !=' : '0'}
      })
      this._getData();
    }
    ...
    _renderItem = ({item, index}) => {
      return (
        <>
          ...
          <TouchableOpacityReal disabled={item.isActive} style={styles.containerInner} onPress={() => this._pilihKamar(item)} activeOpacity={0.9}>
            ...
            <View style={{paddingVertical: 10, paddingHorizontal: 0}}>
              <View style={styles.containerInfo}>
                ...
                <View style={{flex: 1}}>
                  <Text numberOfLines={1} style={[layout.regular, layout.semiBold, {marginVertical: 2}]} category='p2'>{t('aNomorKamar', {nomor_kamar : item.nomor_kamar})}</Text>
            ...
            }
            {
              ...
              <View style={{marginVertical: 10}}>
                <Button size="small" onPress={() => this._onProsesBayar(item)}>Bayar</Button>
              </View>
            }
...
export default connect(mapStateToProps, mapDispatchToProps)(BuktiBayar);
