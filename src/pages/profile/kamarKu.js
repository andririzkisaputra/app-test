...
import { Layout, Text, Spinner, Icon, Input } from '@ui-kitten/components';
...
class KamarKu extends Component {
    ...
    this.state = {
      ...
      menuSort      : [
        ...
        },
        {
          ...
          value : '(sewa.status_sewa = "3" OR sewa.status_sewa = "5")',
          badge : 0,
        },
        {
          label : 'Batal',
...
export default connect(mapStateToProps, mapDispatchToProps)(KamarKu);
