...
class PengeluaranUser extends Component {
        ...
        <View style={styles.containerHeader}>
          <View>
            <View style={{marginBottom: 16}}>
              <Text style={layout.bold}>{item.total_f}</Text>
              <Text style={layout.bold}>{item.kategori?.kategori_pengeluaran}</Text>
              <Text style={{}} numberOfLines={2}>{item.qty +' '+ item.keterangan+'\nTanggal : '+item.tanggal_f}</Text>
            </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(PengeluaranUser);
